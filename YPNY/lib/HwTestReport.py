            ...
            <script type="text/javascript">
                ...
                var option = {
                    ...
                    legend: {
                        orient: 'vertical',
                        left: 'left',
                        dataCollection: ['pass','fail','error']
                    },
                    series : [
                        {
                            name: 'Test Result',
    ...
    def _generate_report_test(self, rows, cid, tid, n, t, o, e):
        ...
        if getattr(t, 'imgs', []):
            ...
            for i, img in enumerate(t.imgs):
                if i == 0:
                    tmp += """ <img src="dataCollection:image/jpg;base64,%s" style="display: block;" class="img"/>\n""" % img
                else:
                    tmp += """ <img src="dataCollection:image/jpg;base64,%s" style="display: none;" class="img"/>\n""" % img
